<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    EnableEventValidation="false" Inherits="Admin_frmKnownProfile" Title="Known Lab Types"
    MaintainScrollPositionOnPostback="true" CodeBehind="frmKnownProfile.aspx.cs" %>
                                        ...
                                        <tr>
                                            <td width="35%" align="left">
                                                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:GridView AllowPaging="true" AllowSorting="true" Width="100%" ID="gvKnownProfile" runat="server" 
                                                              ...
                                                              onpageindexchanging="gvKnownProfile_PageIndexChanging" OnRowDataBound="gvKnownProfile_RowDataBound"
                                                                OnSelectedIndexChanged="gvKnownProfile_SelectedIndexChanged" onsorting="gvKnownProfile_Sorting">
                                                                <HeaderStyle Height="16" CssClass="datagridRowHead" HorizontalAlign="Center" />
					                                                ...
					                                                <asp:TemplateField HeaderText="ID" SortExpression="ID">
							                                            ...
							                                            <center>
								                                            <table cellpadding="0" cellspacing="0" border="0">
									                                            <tr>
										                                            <td >
											                                            <asp:Label ID="lblID" Text='<%# Bind("ID") %>' runat="server" BorderStyle="None" />
										                                            </td>
									                                            </tr>
								                                            </table>
								                                            </center>
                                                ...
                                                <table cellspacing="0" cellpadding="0" border="1" style="border-color: #cccccc" width="99%"
                                                    ...
                                                    <tr>
                                                        <td colspan="2">
                                                            <h3>
                                                                <a href="#"> 
                                                                    <asp:Label ID="lblKnownProfile" Text="Lab Types:" runat="server"></asp:Label>
                                                                </a>
                                                            </h3>
                                                            <div>
		                                                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="tablebg">
                                                                    <tr style="height:40px;">
                                                                        ...
                                                                        <td align="left" class="gridnormal" valign="middle" style="width:500px;">
                                                                            &nbsp;
                                                                        </td>                                                                    
                                                                    </tr>
                                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="left">
                                                            <asp:LinkButton runat="server" ID="lnkDownload" OnClick="lnkDownload_Click">Download Lab Types</asp:LinkButton>
                                                        </td>
                                                        <td align="right">
